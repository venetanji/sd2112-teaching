...
Tools you will need an account for: ClassPoint (student app), Blackboard, PolyU GenAI (`genai.polyu.edu.hk`, your PolyU login: it covers image generation with Flux and Qwen, and language models). Adobe Firefly or Bing Image Creator work as alternatives. Everything else is provided in class.

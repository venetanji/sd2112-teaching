...
| 20% | Individual reflection | *The role of AI in your creative process, with particular attention to the difference between rule-based and adaptive systems.* About 1000 words. Evidence: at least three of your own experiments from the weekly challenges (weeks 2–6), with images. Ends with a short process note on how you used AI to write it. Submitted on Canvas. | Week 7 |

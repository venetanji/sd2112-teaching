...
| 3 | **Learning from examples.** Theories of concepts: the classical theory (definitions; Plato's Meno; Wittgenstein's games) vs prototype theory (Rosch's fruit, typicality); the birth of AI twice: Dartmouth 1956 (GOFAI) and Rosenblatt's perceptron 1958; Hinton, backpropagation and connectionism; parallel calculation, the GPUs made for games, AlexNet; modern AI 2012–2026 in one timeline; combining concepts (pet fish) and conceptual blending. | Plato, *Meno*; Wittgenstein (1953) §66–67; Rosch (1975); Rosch & Mervis (1975); the Dartmouth proposal (1955); Rosenblatt (1958); Minsky & Papert (1969); Rumelhart, Hinton & Williams (1986); Krizhevsky, Sutskever & Hinton (2012); *AlphaGo* (film); Osherson & Smith (1981); Fauconnier & Turner (2002). | Challenge 1 awards. ClassPoint: define "cup" for a machine; name a fruit (the room's prototype); quick checks. p5.js in the slides: a perceptron finding its own line; the Mandelbrot rule painted with one core or four thousand. Activity **The blend**, on PolyU GenAI with the image editors that take references (Flux, Qwen Image Edit): alone, a concept as a picture, uploaded with the concept as a caption of 50 characters or fewer; in pairs, two concepts blended into one picture, up to three reference images; in fours, four concepts, three images, one picture. | **Challenge 2:** a picture from text and references — two or three concepts of your own blended by an image editor from a prompt and one to three reference images of your own. |
